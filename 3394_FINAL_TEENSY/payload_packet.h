...
//#define BOOT 1
//#define ACCENT 2
//#define SP1DEPLOYMENT 3
//#define SP2DEPLOYMENT 4
//#define DESCENT 5
//#define END 6
//===================================================
...
class payload_packet {
  public:
    payload_packet(const uint16_t team_id = 3394);  //assigned to GAGAN
    ...
    */
    ...
    String packet_count;  // the count of transmitted packets, which is to be maintained through processor reset.
    String packet_type;
    String payload_altitude;  // the altitude in units of meters and must be relative to ground level. The resolution must be 0.1 meters.
//    volatile float pressure;  //the measurement of atmospheric pressure in units of pascals. The resolution must be 0.1 pascals.
    String payload_temperature; // the sensed temperature in degrees C with one tenth of a degree resolution.
